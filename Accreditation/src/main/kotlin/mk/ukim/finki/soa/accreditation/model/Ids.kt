...
@Embeddable
open class StudyProgramDetailsId(value: String) : Identifier<StudyProgramDetails>(value, StudyProgramDetails::class.java){
    constructor() : this(UUID.randomUUID().toString())
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return this.value == (other as StudyProgramDetailsId).value
    }
