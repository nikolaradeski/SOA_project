package mk.ukim.finki.soa.accreditation.handlers.eventHandlers
...
import mk.ukim.finki.soa.accreditation.model.AbstractEvent
...
class EventMessagingEventHandler(val eventMessagingService: EventMessagingService) {
    ...
    fun on(event: AbstractEvent) {
        ...
        val cloudEvent: CloudEvent = CloudEventBuilder.v1()
            ...
            .withSource(URI.create("accreditation-service"))
